...
public class GUITree extends javax.swing.JFrame {
        ...
        this.TreeView.addTreeSelectionListener(new TreeSelectionListener() {
            ...
            public void valueChanged(TreeSelectionEvent e) {
                ...
                if (selectedNode != null) {
                    ...
                    DesObj o = new DesObj(sp[0], sp.length > 1 ? sp[1] : "");
    ...
    private void defaultTree() {
        DesObj urano = new DesObj("Urano", "Gea", 1, 2);
        DesObj afrodita = new DesObj("Afrodita", "", 3, 4);
        DesObj cronos = new DesObj("Cronos", "Rea", 5, 6);
        DesObj atlas = new DesObj("Atlas", "", 7, 8);
        DesObj prometeo = new DesObj("Prometeo", "", 9, 10);
        DesObj eros = new DesObj("Eros", "", 11, 12);
        DesObj zeus = new DesObj("Zeus", "", 13, 14);
        DesObj poseidon = new DesObj("Poseidón", "", 15, 16);
        DesObj hades = new DesObj("Hades", "", 17, 18);
        DesObj ares = new DesObj("Ares", "", 19, 20);
        DesObj apolo = new DesObj("Apolo", "", 21, 22);
        DesObj atenea = new DesObj("Atenea", "", 23, 24);
        DesObj hermes = new DesObj("Hermes", "", 25, 26);
        DesObj heracles = new DesObj("Heracles", "", 27, 28);
